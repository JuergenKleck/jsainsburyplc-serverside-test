...
class FileReaderTest {
    ...
    public void givenFile_whenLoading_returnProperties() throws Throwable {
        ...
        Assertions.assertDoesNotThrow(() -> {
            reader.openFile("empty.properties");
        });
    }

    @Test
    public void givenFile_whenLoadingEmptyFile_returnNoProperties() throws Throwable {
        FileReader reader = new FileReader();
        Assertions.assertDoesNotThrow(() -> {
            reader.openFile("empty.properties");
        });
    ...
    @Test
    public void givenFile_whenLoading_returnNonEmptyProperties() throws Throwable {
        FileReader reader = new FileReader();
        Assertions.assertDoesNotThrow(() -> {
            reader.openFile(ConfigConstants.FILE_NAME);
        });
        Assertions.assertTrue(reader.getProperties() != null);
